...
export function SharedPhoto({
  ...
  return (
    <div className="shared-photo-card">
      ...
      <img alt={`Photograph from ${galleryTitle}`} className="shared-photo-image" height={photo.height ?? undefined} src={src} style={{ aspectRatio: ratio }} width={photo.width ?? undefined} />
